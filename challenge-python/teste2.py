def menu():
    print('\nBem vindo ao Porto Seguro Repair! Abaixo você encontra o nosso menu com as funções do nosso site! ')
...
def servicos():
    print('\nVocê está na aba Serviços! Abaixo você pode ver os nossos serviços pra você!\n')
...
def cadastro():
    print('\nVocê está na aba Cadastro! Abaixo você pode se cadastrar no nosso site!\n')
...
def agendamento():
    print('\nVocê está na aba Agendamento! Abaixo você pode agendar uma manutenção ou revisão no nosso site!\n')
...
def sobre():
    print('\nVocê está na aba Sobre! Abaixo você pode ler um pouco sobre a história da Porto!\n')
...
def index():
    while True:
        ...
        if escolha == 1:
            ...
            print("Contato")
            # Adicione aqui a função ou código para a aba de Contato
